...
const Dashboard = () => {
    ...
    useEffect(() => {
        // CHECK IF THERE IS A USER, IF THERE IS NONE, NAVIGATE TO LOGIN PAGE 
        if (!user) {
            navigate("/login")
            return;
        }
    ...
    // SETTING ACCOUNT BALANCE FOR USERS 
    useEffect(() => {
    ...
    return (
        <div className='bg-[#EFF2F9] flex flex-col md:flex-row min-h-screen'>
            ...
            {/* SIDENAV */}
            <nav className="hidden md:flex md:w-3/12 bg-[#FFFFFF80] rounded-tr-[100px] rounded-br-[100px] py-10 px-[52px]">
                <div>
                    <div>
                        <img src={Logo} alt="Logo" className="w-[90px] h-[28px]" />
                    </div>
            ...
            <div className='w-full md:w-9/12 mx-auto px-4 flex-grow'>
                ...
                <div className='mt-8 flex flex-col md:flex-row md:justify-between gap-4'>
                    ...
                    <div className='hidden md:flex justify-between md:justify-end items-center gap-[21px] flex-wrap'>
                ...
                <div className='mt-4'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-5'>
                        ...
                        <div className="bg-[#7395F9] py-3 px-[42px]">
                            <p className='text-[17px] text-[#FFFFFF] font-[600]'>ALL MEMBERS</p>
                            <p className='text-[28px] text-[#FFFFFF] font-[600]'>{allMembers}</p>
                        </div>
                        <div className="bg-[#7395F9] py-3 px-[42px]">
